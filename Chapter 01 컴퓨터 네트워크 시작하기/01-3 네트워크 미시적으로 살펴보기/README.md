...
### Q16. OSI 모델 중 세션 계층의 역할은?

<details> <summary>정답</summary>

#### 통신을 주고 받는 호스트의 응용 프로그램 간 연결 상태를 생성하거나 유지하고, 종료되었을 때는 끊어주는 역할을 담당한다.

</details>

### Q17. 대역폭(Bandwidth)이 의미하는 것은 무엇인가?
1. 네트워크에서 사용 가능한 최대 전송 용량
2. 데이터가 손실 없이 전달되는 속도
3. 네트워크 장비의 처리 속도를 의미하는 용어
4. 패킷이 전송될 때 걸리는 시간
...
대역폭(Bandwidth)은 특정 시간 동안 네트워크를 통해 전송할 수 있는 데이터의 최대 용량을 의미함.
보통 초당 비트(bit per second, bps) 단위로 측정됨.
