...
### Q14. 다음 중 공인 IP와 사설 IP의 차이에 대한 설명으로 옳은 것은?

#### 1️⃣ 공인 IP는 전 세계적으로 유일하지만, 사설 IP는 여러 네트워크에서 중복되어 사용할 수 있다.
#### 2️⃣ 사설 IP는 직접 인터넷에 연결될 수 있으며, 공인 IP는 오직 내부 네트워크에서만 사용된다.
#### 3️⃣ 사설 IP 주소는 전 세계적으로 고유한 값을 가지며, 공인 IP 주소는 동일한 값을 가질 수 있다.
#### 4️⃣ 공인 IP는 오직 개인 네트워크에서만 사용되고, 사설 IP는 글로벌 네트워크에서 사용된다.
...
---
**[해설]**
#### 2️⃣ 사설 IP는 인터넷에 직접 연결되지 못한다. (NAT을 거쳐야 가능)
#### 3️⃣ 공인 IP가 유일한 값이고, 사설 IP는 여러 네트워크에서 중복될 수 있다.
#### 4️⃣ 공인 IP는 글로벌 네트워크에서 사용되고, 사설 IP는 개인 네트워크에서 사용된다.
</details>
